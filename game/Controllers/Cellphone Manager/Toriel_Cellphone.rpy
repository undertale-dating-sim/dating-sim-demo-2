...
label call_Toriel_Cave_Room(owner = False):
    ...
    toriel "Oh, this is where Frisk and you fell, is it not? It must have been quite a hard landing."
    toriel "I am glad that those flowers were there to break your fall at least!"
...
label call_Toriel_Grass_Room(owner = False):
    ...
    toriel "Sometimes in this room, a little yellow flower will pop up from the patch of grass that sits in the light."
    toriel "It may not look it, but it is quite the trouble-maker. Do not ever agree to follow it anywhere you will not be able to call me, alright?"
    toriel "Take care!"
    return
...
label call_Toriel_Ruins_Entrance(owner = False):
    ...
    menu:
        "What do you think?"
        "It's nice.":
            toriel "Hm. I do not think it is anything special - but if the both of you seem to agree then maybe I am wrong."
        "It's dirty.":
