...
label call_Toriel_Ruins_Entrance(owner = False):
    ...
    if "ruins_phonecall" in owner.variables:
        toriel "I suppose the vines do have a certain aesthetic appeal."
    else:
        $ owner.variables["ruins_phonecall"] = 1
        toriel "Hello, Toriel here!"
...
label call_Toriel_Monster_Candy_Room(owner = False):
    toriel "Hello, Toriel here!"
...
label call_Toriel_Blooky_Room(owner = False):
    ...
    if 'ruins_blookyroom_call' not in owner.variables:
        $ owner.variables['ruins_blookyroom_call'] = 1
        toriel "Hello, Toriel here!"
...
label call_Toriel_Spider_Bakery(owner = False):
    ...
    if 'spider_backer_cellphone' not in owner.variables:
        $ owner.variables['spider_backer_cellphone'] = 1
        toriel "Hello, Toriel here!"
...
label call_Toriel_Overlook(owner = False):
    ...
    if 'ruins_overlook_cellphone' in owner.variables:
        $ owner.variables['ruins_overlook_cellphone'] = 1
        toriel "Hello, Toriel here!"
...
label call_Toriel_Same_Room(owner = False):
    if 'same_room_cellphone' not in owner.variables:
        $ owner.variables['same_room_cellphone'] = 1
        show toriel normal
        toriel "Hello? Oh!"
