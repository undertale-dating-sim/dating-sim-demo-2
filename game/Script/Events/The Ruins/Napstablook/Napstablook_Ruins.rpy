...
##################################################################      HANGOUT 1       ##################################################################
    ...
    #Napstablook is giving you snail-hunting advice.
        ...
        menu:
            "What types of snails are there in the Ruins?" if ruinsnails_asked is False: #(+1 FP)
                blooky "oh, there’s not much difference between the snails here...."
                blooky "the snails in waterfall are a little more diverse and interesting......"
                blooky "...um, not that the snails here aren’t interesting, just......."
                blooky "well, nevermind...."
            ...
            "Why are there so many snails in this room?" if torielsnails_asked is False: #(+1 FP)
                blooky "i don’t actually know.... i think Toriel does something to the grass here...."
    ...
    label blooky_tl_date:
        #Event Name: "Blooky's TL Date"
        #Event Trigger: A meddling small white dog
        ...
        menu:
            "Just the two of us, then.": #(+3 DP)
                show napstablook normal
                blooky "yeah..."
                blooky "just you and me..."
                blooky "i hope that’s okay.... ...i generally come to the ruins to be alone so..."
                blooky "usually my music is good company"
            ...
            "Are people avoiding you?": #(+1 HB)
                ...
                jump tl_downer_response
        jump tl_date_start
                
        label tl_downer_response:
            menu:
                "Well I don’t think you’re a downer.": #(+1 HB)
                    show napstablook smile
                    blooky "oh.... good..."
                    blooky "im glad.... ... at least there’s still you"
                "Quietly smile.": 
        ...
        label tl_date_start:
            ...
            menu:
                "Yeah, that sounds like fun!": #(+2 DP)
                    show napstablook smallsmile
                    blooky "o-okay... i'm glad you think so..."
                    blooky "i guess i’ll start… we can take turns...."
                "I guess, if that’s what you want to do…": #(+1 FP)
                    show napstablook normal
                    blooky "oh..... um........ okay...."
                    blooky "i  guess i’ll start...... we can take turns....."
            jump tl_blooky_date_questions
        
        label tl_blooky_date_questions:
            $ randnum = renpy.random.randint(1,11)
            ...
            show napstablook normal
            if randnum == 1 and asked_1 == False:
                $ asked_1 = True
                $ question_num += 1
                show napstablook normal
                blooky "so… what did you enjoy doing... ...in your free time?"
                blooky "back when you were up on the surface?"
                jump napstablook_tl_date1_hobbies
                
                label napstablook_tl_date1_hobbies:
                    menu:
                        "I enjoyed creating art.": #(+1 DP)
                            show napstablook smallsmile
                            blooky "oh really?"
                            blooky "that's nice... i like to make art too"
                            jump tl_ask_blooky
                        "I enjoyed reading.": #(+1 DP)
                            blooky "reading is nice..."
                            blooky "...i don't read much..."
                            blooky "but i heard it's really relaxing....."
                            blooky "that's a good hobby."
                            jump tl_ask_blooky
                        "I went to the gun range often.": #(+1 FP)
                            blooky "the gun range.... i don’t think i’ve ever been..."
                            blooky "but then again.... ...."
                            blooky "i don’t think i’ve ever used a gun...."
                            blooky "it’s too dangerous...."
                            blooky "but you’re very brave."
                            jump tl_ask_blooky
                        "I loved to dance": #(+1 DP)
                            if isdancer is False:
                                show napstablook normal
                                blooky "dancing? wow..."
                                blooky "that sounds like fun......."
                                blooky "sometimes, i dance to the music i play at home."
                                show napstablook smallsmile
                                blooky "i bet you're a great dancer."
                                jump tl_ask_blooky
                            if isdancer is True:
                                show napstablook smallsmile
                                blooky "ha, i should've guessed...."
                                blooky "i like your dancing... it's funny....."
                                blooky "but, um... not in a bad way...."
                                jump tl_ask_blooky
                        "I enjoyed cooking and baking.": #(+1 DP)
                            show napstablook smallsmile
                            blooky "oh wow"
                            blooky "that's really cool....."
                            blooky "one of my friends likes to cook..."
                            blooky "...and my cousin has his own cooking show on tv..."
                            blooky "i think you'd really like them."
                            jump tl_ask_blooky
                        "I liked to exercise.": #(+1 DP)
                            show napstablook normal
                            blooky "exercise?"
                            blooky "like flexing?"
                            blooky "...aaron likes to walk around flexing at people..."
                            blooky "if you bumb into him, maybe you two can compete..."
                            blooky "...."
                            blooky "it takes a lot of walking to get around the underground... so...."
                            blooky "i think you'll get plenty of exercise down here"
                            jump tl_ask_blooky
                        "I didn't do much." if apathy == False: #(+1 FP)
                            show napstablook normal
                            blooky "really?"
                            show napstablook sad
                            blooky "that... sounds sad...."
                            show napstablook normal
                            blooky "did you never find anything you fit into?"
                            blooky "nothing at all?"
                            menu:
                                "Well, actually, maybe there is something.": #(+0)
                                    blooky "what did you like to do, then?"
                                    $ apathy = True
                                    jump napstablook_tl_date1_hobbies
                                "Nope.": #(-2 DP)
                                    blooky "wow..."
                                    blooky "the surface must be really boring if even someone like you couldn't find anything to do...."
                                    blooky "maybe it's a good thing... you know...."
                                    blooky "that you're down here after all."
                                    jump tl_ask_blooky
                                    
                            
            if randnum == 2 and asked_2 == False:
                $ asked_2 = True
                $ question_num += 1
                show napstablook normal
                blooky "i really find this place.... well......"
                ...
                menu:
                    "It's a beautiful place.": #(+3 DP)
                        show napstablook normal
                        blooky "yeah.... i think so too..."
                        blooky "i like to wander around sometimes......"
                        blooky "but usually i end up here...."
                        blooky "it's really serene."
                        jump tl_ask_blooky
                    "It’s kind of eerily quiet.": #(+2 FP)
                        blooky ".....is it?"
                        blooky "i like it quiet sometimes....."
                        blooky "don’t be worried… we’re here together, so....."
                        blooky "maybe it won’t be as scary as you think....."
                        jump tl_ask_blooky
                    "I don't care where we are, so long as I'm here with you.": #(+4 DP)
                        show napstablook sad
                        blooky "o-oh.........."
                        blooky "............"
                        blooky "...."
                        ...
                        blooky "i don't know what to say."
                        jump tl_ask_blooky
                    "I couldn’t really care less about this place.": #(+2 HB)
                        show napstablook sad
                        blooky "oh"
                        blooky "........you don't like it?"
                        
                        menu:
                            "I like you, but not this place.": #(+1 HB)
                                show napstablook shyblush
                                blooky "o-oh..... really?"
                                blooky "well........"
                                show napstablook smile
            ...
            if randnum == 3 and asked_3 == False:
                $ asked_3 = True
                $ question_num += 1
                blooky "i know you haven’t been underground that long, but..."
                blooky ".....i hope you’re enjoying yourself"
                ...
                menu:
                    "It's nice down here, and you're not boring at all!": #(+2 DP)
                        show napstablook normal
                        blooky "really?"
                        blooky "oh... that's good."
                        blooky "i'm sure i get on people's nerves eventually...."
                        blooky "this is a good start..."
                        jump tl_ask_blooky
                    "I’m just a little tired, but I’m having fun.": #(+1 FP)
                        show napstablook normal
                        blooky ".......oh..... do you need to rest?"
                        blooky "i’m happy you’re having fun..... but......"
                        blooky "if you’re tired you should really get some rest......."
                        ...
                        menu:
                            ...
                            "I'll get over it.": #(+0)
                                ...
                                blooky "hm........."
                                jump tl_ask_blooky
                    "It gets pretty dull around here, I won't lie.": #(-2 FP)
                        show napstablook normal
                        blooky "you think so?"
                        blooky "i’m sorry....... i wish i was better at entertaining people......."
                        blooky "i don’t go out much..... and i’m usually alone so......"
            ...
            if randnum == 4 and asked_4 == False:
                $ asked_4 = True
                $ question_num += 1
                blooky "actually......"
                blooky "i think you’d get along with my cousin......"
                ...
                menu:
                    "Robots are cool!": #(+3 DP)
                        $temp = 0
                        jump tl_coolrobot
                    "They’re pretty neat.": #(+2 FP)
                        label tl_coolrobot:
                            show napstablook smile
                            blooky "yeah?"
                            blooky ".....my cousin is a robot....."
                    ...
                    "Depends on the robot...": #(-1 FP)
                        ...
                        menu:
                            ...
                            "Not really.": #(-3 FP)
                                ...
                                menu:
                                    "I hope that didn’t come out wrong!": #(+2 FP)
                                        blooky "no... no it's ok..."
                                        blooky "i just..... wish you'd give robots a chance....."
                                        blooky "......but oh well..."
                                        jump tl_ask_blooky
                                    "But I do like ghosts.": #(+3 HB)
                                        blooky "a-ah....."
                                        show napstablook shyblush
                                        blooky "well........"
                                        blooky "that’s good........ i think"
            ...
            if randnum == 5 and asked_5 == False:
                $ asked_5 = True
                $ question_num += 1
                show napstablook normal
                blooky "well....... i only really ever come here to relax..."
                ...
                menu:
                    ...
                    "Not really, no.": #(+1 FP)
                        ...
                        blooky "........."
                        jump tl_ask_blooky
                    "Only from people with emotional baggage.": #(-2 FP)
                        blooky "........"
                        blooky "......oh"
                        show napstablook sad
                        blooky "i’m sorry i....... i didn’t realize......."
                        ...
                        menu:
                            "That’s not what I meant, I’m sorry...": #(+1 FP)
                                blooky "oh.....?"
                                blooky "it's ok....."
                                blooky "i was just worried that..... i was annoying you....."
                                blooky "i wouldn't be surprised..... but it's fine......"
                                jump tl_ask_blooky
                            "It’s okay, I’ll be around to cheer you up.": #(+2 HB)
                                blooky "...really?"
                                blooky "oh..... good."
                                blooky "i know that i..... get sad a lot..... it can make people uncomfortable and upset....."
                                blooky "maybe with you around i can cheer up more"
            ...
            if randnum == 6 and asked_6 == False:
                $ asked_6 = True
                $ question_num += 1
                blooky "i wouldn’t call myself a hermit, but..."
                blooky "i like to be alone a lot..."
                ...
                menu:
                    "All the time!": #(+4 DP)
                        show napstablook normal
                        blooky "that's cool."
                        blooky "i think whenever i do feel like hanging out and meeting people..."
                        blooky "i usually find myself... wandering in waterfall..."
                        blooky "or going to the MTT hotel and cafe....."
                        blooky "that place is really popular though....."
                        blooky "so i don't stay for too long."
                        jump tl_ask_blooky
                    "Yes.": #(+1 DP)
                        show napstablook normal
                        blooky "you.... don't sound very happy about that..."
                        blooky "but i guess any chance you got was a good one... right?"
                        blooky "that must feel nice, though... to meet new people..."
                        jump tl_ask_blooky
                    "A few places.": #(+1 FP)
                        show napstablook normal
                        ...
                        blooky "that's good......"
                        jump tl_ask_blooky
                    "I don’t socialize much.": #(+1 FP)
                        show napstablook normal
                        blooky "oh..... really?"
                        blooky "well..... i don’t either... if that makes it any better..."
                        
                        menu:
                            "I’d rather just talk to you.": #(+2 HB)
                                show napstablook shyblush
                                blooky "that's........."
                                blooky "......."
                                show napstablook smile
                                blooky "you're really nice....."
                                jump tl_ask_blooky
                            "That’s why we get along so well.": #(+1 FP)
                                blooky "yeah?"
                                blooky "we do..... don't we....."
                                blooky "hehe....."
                                jump tl_ask_blooky
                            "I just don’t see a point in it.": #(-1 FP)
                                blooky "i understand..."
                                blooky "i’m the same way sometimes, but......"
                                blooky "some days it’s really nice to go to a friend..... or just..... let go....."
                                blooky ".....well for me at least"
            ...
            if randnum == 7 and asked_7 == False:
                $ asked_7 = True
                $ question_num += 1
                blooky "i actually come here to cry sometimes..."
                blooky ".....not a lot, but enough i guess to not want others to see what i’m doing"
                ...
                label tl_trash_q:
                    menu:
                        "Excuse me?!" if feelliketrash is False: #(-3 DP)
                            blooky "huh?"
                            blooky "n-no..... not..... bad..... but-"
                            blooky "i don’t know how to....... explain myself..."
                            blooky "just laying around....... not caring what happens?"
                        ...
                        "Not really.": #(+2 FP)
                            ...
                            blooky "it’s not so bad..... it’s kinda relaxing....."
                            jump tl_ask_blooky
                        "Only trash should feel like trash.": #(+3 HB)
                            blooky "i... well......"
                            blooky "i am trash..."
                            
                            menu:
                                "Then I guess you’re cute and classy trash.": #(+1 HB)
                                    blooky "heheheh........."
                                    show napstablook smile
                                    blooky ".....do you really think i’m classy?"
                                    blooky "........maybe some other time..... i can show you my....."
            ...
            if randnum == 8 and asked_8 == False:
                $ asked_8 = True
                $ question_num += 1
                blooky "......."
                blooky "did i mention that i own a snail farm?"
            ...
            if randnum == 9 and asked_9 == False:
                $ asked_9 = True
                $ question_num += 1
                blooky "what type of music do you like listening to?"
                blooky "if it’s okay to ask....... you probably haven’t heard anything in awhile since you fell..."
                ...
                label tl_musicq:
                    menu:
                        "Pop": #(+2 DP)
                            ...
                            blooky "i think i like pop, too"
                            jump tl_ask_blooky
                        "Hip Hop and R&B": #(+2 DP)
                            blooky "hip..... hop.....?"
                            blooky "i don’t think i’ve heard of that before..."
                            blooky "it must be hip"
                            blooky "does it get humans to hop?"
                            jump tl_ask_blooky
                        "Trap and Trance": #(+2 DP)
                            blooky "trap?"
                            blooky "there are a lot of old puzzles and tests through the ruins..."
                            blooky "i’m sure if you get a few wrong, you’ll find plenty of traps..."
                            blooky "........."
                            blooky "though i don’t think they sound all that great, to be honest"
                            jump tl_ask_blooky
                        "Dance and Techno": #(+2 DP)
                            blooky "dance and techno... huh..."
                            blooky "technology types of things sound like something the royal scientist would know about..."
                            blooky "and i can’t dance..."
                            blooky "at least........ not well..."
                            jump tl_ask_blooky
                        "Classical and Instrumental": #(+2 DP)
                            blooky "i don’t know what classical is... but..."
                            blooky "instrumental i do."
                            blooky "i think..... i like instrumental, too..."
                            blooky "i don’t have a lot of instruments, though....."
                        ...
                        "Jazz and Swing.": #(+2 DP)
                            ...
                            blooky "that's cool"
                            jump tl_ask_blooky
                        "I don't like music." if dislikedmusic is False: #(-1 FP)
                            blooky "really?"
                            blooky "well......"
                            blooky "what do you like?"
                            ...
                            menu:
                                ...
                                "You.": #(+2 HB)
                                    ...
                                    blooky "...but i also like music."
                                    jump tl_ask_blooky
            if randnum == 10 and asked_10 == False:
                $ asked_10 = True
                $ question_num += 1
                blooky "um....."
                show napstablook sad
                ...
                menu:
                    "Yeah, I understand how you feel.": #(+2 FP)
                        show napstablook normal
                        blooky "yeah"
                        blooky "it feels..... like it takes up a lot of energy"
                        blooky ".....i get tired easily and i start to feel..... small....."
                        blooky "it’s easier to just avoid it altogether"
                        jump tl_ask_blooky
                    "Don't worry, you never have to feel that way with me.": #(+3 HB)
                        show napstablook normal
                        blooky "oh........ well, that's nice........"
                        blooky "i'm glad......"
                        blooky ".....you make me feel very..... relaxed"
            ...
            if randnum == 11 and asked_11 == False:
                $ asked_11 = True
                $ question_num += 1
                ...
                menu:
                    "I can't say I had many friends. I used to spend my days alone.": #(+1 DP)
                        blooky "oh..."
                        blooky "i know the feeling.... i don't have many friends either..."
                        show napstablook smallsmile
                        blooky "...though it's better to have a few good friends than to have many bad ones..."
                        blooky "but that might just be me..."
                        jump tl_ask_blooky
                    "I was pretty popular up there; people must be looking for me even now.": #(+1 FP)
                        blooky "i....never got to know how it feels to be popular..."
                        blooky "the only popular person i know is my cousin.... he’s amazing..."
                        show napstablook smallsmile
                        blooky "i guess you’re amazing too.... that’s...nice..."
                        jump tl_ask_blooky
                    "I had tons of friends. What do you take me for, a loser?": #(+2 HB)
                        show napstablook surprised
                        blooky "no...sorry.... i didn’t mean to upset you..."
                        show napstablook sad
                        blooky "i don’t have many friends and i thought that..."
                        blooky "..."
                        blooky "....nevermind... sorry..."
                        jump tl_ask_blooky
                    "No, I didn't have any. I didn't bother interacting with people too often.": #(+2 DP)
                        blooky "oh...."
                        blooky "watching them....seems more interesting than participating..."
                        blooky "but not always..."
                        blooky "..."
                        blooky "...i enjoy being out here with you, though..."
                        jump tl_ask_blooky
                        
                        
            if randnum == 1 and asked_1 == True:
                jump tl_blooky_date_questions
                
            if randnum == 2 and asked_2 == True:
                jump tl_blooky_date_questions
                
            if randnum == 3 and asked_3 == True:
                jump tl_blooky_date_questions
                
            if randnum == 4 and asked_4 == True:
                jump tl_blooky_date_questions
                
            if randnum == 5 and asked_5 == True:
                jump tl_blooky_date_questions
                
            if randnum == 6 and asked_6 == True:
                jump tl_blooky_date_questions
                
            if randnum == 7 and asked_7 == True:
                jump tl_blooky_date_questions
                
            if randnum == 8 and asked_8 == True:
                jump tl_blooky_date_questions
                
            if randnum == 9 and asked_9 == True:
                jump tl_blooky_date_questions
                
            if randnum == 10 and asked_10 == True:
                jump tl_blooky_date_questions
                
            if randnum == 11 and asked_11 == True:
                jump tl_blooky_date_questions
        ...
        label tl_ask_blooky:
            ...
            if question_num is 3:
                blooky "i’m sorry..... is this boring? maybe this question thing was a bad idea....."
                menu:
                    "I'm having fun! Let's keep going!": #(+2 FP)
                        show napstablook smile
                        "really? okay, it's your turn then..."
                    "It's never boring hanging out with you.": #(+2 DP)
                        show napstablook shyblush
                        blooky "o-oh..... ha..... that's nice of you to say......"
                        blooky "let's keep going, then, if you're having fun...... it's your turn, then....."
                    "Yeah, I'm bored. Let's stop.": #(-1 DP)
                        jump tl_end_blook_date
            if question_num is 4:
                blooky "okay, you go... i think i like it better when it's your turn to ask the questions..... it's less pressure......"
            if question_num is 5:
                blooky "i think i'm out of questions.... i can't think of any more...."
            ...
            menu:
                "What do you think of humans?": #(+2 DP)
                    show napstablook normal
                    blooky "they seem really nice..."
                    show napstablook smile
                    blooky "...and so are you... so..."
                    ...
                    menu: 
                        ...
                        "Definitely not.": #(-2 FP)
                            $ temp = 0
                            jump tl_notnice
                        "Not all of us are nice.": #(+2 HB)
                            label tl_notnice:
                                show napstablook normal
                                blooky "huh?"
                                blooky "what do you mean?"
                                menu:
                                    "Some people are just jerks.": #(-2 FP)
                                        blooky "oh"
                                        blooky "..........well, i just hope that..."
                                        blooky "you aren’t one of them..."
                                    "Nothing, sorry about that.":
                                    ...
                                    "I’m worried that I’m the only that can be trusted.": #(+HB)
                                        ...
                                        show napstablook smallsmile
                                        blooky "you can always trust me........ know that"
                "Can you eat normal food? Does it phase through you?": #(+2 FP)
                    $ asked_ghostfood == True
                    show napstablook normal
                    blooky "human food passes through me, yeah"
                    blooky "but ghost food... and monster food...."
                ...
                "What are your hobbies?": #(+1 DP +1 FP)
                    show napstablook normal
                    blooky "i like to make music"
                    blooky ".....i like to think i’m good at it... i’ve been told it’s pretty good, but..."
                ...
                "Are any of the other monsters as nice as you?":#(+1 DP +1 FP)
                    show napstablook surprised
                    blooky "o-oh..... i mean...... i don't know"
                    show napstablook normal
                    blooky "probably"
                ...
                "Weren’t monsters just a myth or some legend?": #(+2 FP)
                    show napstablook normal
                    blooky "i thought humans were a myth, too"
                    blooky "......then i saw frisk..."
                    blooky "though, i never bumped into humans as much as i did other monsters"
                ...
                "Are you self conscious about being a shut-in?" if hobbies_asked == True: #(+3 HB)
                    show napstablook normal
                    blooky "w-well....... a little bit..."
                    blooky "i know i can be awkward sometimes......."
                    blooky "i know i bother people just by being around them......."
                ...
                "One day, will you show me your music?" if napstablook_friendship_hangout1_complete == False: #(+2 DP) ONLY AVAILABLE IF YOU DIDN'T COMPLETE HANGOUT 1 ALREADY
                    show napstablook normal
                    blooky "......i would....."
                    blooky "but i don't have it with me right now..."
                    blooky "maybe you can come over to my place sometime?"
        ...
        label tl_end_blook_date:
            ...
            menu:
                "DP":
                    jump napstablook_tl_date1_DP_ending
                "FP":
                    jump napstablook_tl_date1_FP_ending
                "Failed Date":
                    jump napstablook_tl_date1_Failed_ending
            
            jump blooky_ruins
            
        label napstablook_tl_date1_DP_ending:
            show napstablook smallsmile
            blooky "wow.... ...i’m actually glad we got to hang out..."
            show napstablook normal
            blooky "it was nice, i never realized.... how much fun it would be to..... well..."
            show napstablook smallsmile
            blooky "meet someone new."
            blooky "........."
            show napstablook normal
            blooky "i should really get going...."
            blooky "this was fun, though."
            blooky "i hope.... that we can hang out again sometime..."
            blooky "here’s my phone number....if you want to....hang out again, then just......"
            blooky "call.... i guess..."
            #player gets blooky's phone number
            #Fades away
            blooky "bye..."
            blooky "..."
            # $ date_success = True
