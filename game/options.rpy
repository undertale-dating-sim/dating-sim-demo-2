...
init -1 python hide:
    ...
    style.window.right_padding = 28
    style.window.top_padding = 25
    style.window.bottom_padding = 22
...
python early:
    config.save_directory = "inLove: An Undertale Dating Simulator (Demo)-1461268408"
...
init python:
    ...
    build.directory_name = "inLove-demo"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "inLove-demo"
